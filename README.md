...
It extends our 2023 release in the *Journal of Computational Design and Engineering* (https://doi.org/10.1093/jcde/qwad059) by introducing **AirDbM**, a compact 12-baseline implementation of Design-by-Morphing (DbM) that preserves geometric diversity while halving the number of design variables.

## Abstract  

Design-by-Morphing (DbM) offers rich shape variation with few parameters, yet its efficiency hinges on the size of the baseline set. DbM for airfoil optimization, **AirDbM**, now systematically selects just 12 representative airfoils from the 1,600-shape UIUC database via a forward-search baseline selection that maximizes reconstruction capability.  
...
* Link: *[link-to-be-added-after-acceptance]*
* Data: See `GAOutput_MO.mat` of this repository (MATLAB-compatible data format)  

> The 2023 article *"Airfoil Optimization using Design-by-Morphing"* is available at https://doi.org/10.1093/jcde/qwad059.
...
*UC Berkeley CFD Lab - Airfoil Shape Optimization via Design-by-Morphing (AirDbM)*